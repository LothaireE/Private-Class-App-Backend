...
class CoachProfile(models.Model):
    ...
    day_starts_at = models.TimeField(default="08:00")
    day_ends_at = models.TimeField(default="20:00")
    break_starts_at = models.TimeField(blank=True, null=True)
    break_ends_at = models.TimeField(blank=True, null=True)
    instagram_url = models.URLField(blank=True)
    whatsapp_url = models.URLField(blank=True)
    website_url = models.URLField(blank=True)
    disciplines = models.ManyToManyField(Discipline, blank=True, related_name="coach_profiles")
    offered_topics = models.JSONField(default=list, blank=True)
